...
//        uint256 passedTime = block.timestamp - startDay;
        uint256 passedTime = getCurrentDate() - startDay;
    ...
    function getCurrentDate() public view returns(uint256 _date) {
        return  block.timestamp + timeSeek;
    }

    function setSeek(uint256 _value) external onlyOwner {
        timeSeek = _value;
    }
